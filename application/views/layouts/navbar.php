      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <?php } else { ?>      
             <?php if ($this->uri->segment(1)!="orderform") { ?> <a class="btn btn-info" style="margin: 7px 0px 0px 5px;" href="<?php echo base_url()."orderform"; ?>" role="button"><i class="fa fa-plus-circle" aria-hidden="true" style="margin-right: 5px;" ></i><?php echo $this->lang->line('plus_order'); ?></a><?php } ?>
            <?php } ?>
          </div>

...
class Orderform extends CI_Controller {
    ...
    public function index($userLang) {
      ...
      $pageData['plug_components'] = $this->Data_forall->get_plug_components( array( "jquery",/*"bootstrapvalidate",*/"bootstrap","font_awesome" ) );
      ...
      /*
      if (isset($_POST['butt_send_order'])) {
       ...
       if ($this->form_validation->run() == FALSE) { 
        ...
        $id_order = $this->Data_uni->uni_insert($data,"orders");
     ...
     // $pageData['order'] = $this->Data_orderform->get_order(7);
